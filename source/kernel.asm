;*****************start of the Sahan_OS kernel code***************
[org 0x000]
[bits 16]
...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to Sahan_OS version 0.0.1", 0x00

	wel1 db	'*************************************************', 0x00			

	wel2 db '*********** WELCOME TO Sahan_OS ************', 0x00 
	...
	wel7 db ' version 0.0.1 of Sahn_OS From D. D. Sahan Rashmika Silva - SE/2019/036', 0x00
	...
	strPrompt		db	"SahanOS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"Sahan", 0x00	;OS details
